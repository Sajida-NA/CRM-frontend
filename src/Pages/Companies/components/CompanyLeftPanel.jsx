...
export default function CompanyLeftPanel({
  ...
  const handleCallCreated = async (createdCall) => {
    console.log("Company call created:", createdCall);
  ...
  const handleNoteCreated = async (createdNote) => {
    console.log("Company note created:", createdNote);
  ...
  const handleEmailCreated = async (createdEmail) => {
    console.log("Company email created:", createdEmail);
  ...
  const handleTaskCreated = async (createdTask) => {
    console.log("Company task created:", createdTask);
