...
import CompanyActivities from 
"../Pages/Companies/components/Tabs/Activity/CompanyActivities"; 
import CompanyMeeting from 
"../Pages/Companies/components/Tabs/Meeting/CompanyMeeting"; 
import CompanyNote from 
"../Pages/Companies/components/Tabs/Note/CompanyNote"; 
import CompanyCalls from 
"../Pages/Companies/components/Tabs/Calls/CompanyCalls"; 
import CompanyTask from 
"../Pages/Companies/components/Tabs/Task/CompanyTask"; 
import CompanyEmail from 
"../Pages/Companies/components/Tabs/Emails/CompanyEmail"; 
...
<Route path="/leads/:leadId/activity" element={<LeadActivities />} /> 
{/* <Route path="/leads/:leadId/activities" element={<LeadActivities />} /> */} 
<Route path="/leads/:leadId/note" element={<Leadnote />} /> 
<Route path="/leads/:leadId/calls" element={<Leadcalls />} /> 
<Route path="/leads/:leadId/meeting" element={<LeadMeeting />} /> 
<Route path="/leads/:leadId/task" element={<LeadTask />} /> 
<Route path="/leads/:leadId/email" element={<LeadEmail />} /> 
{/* ================= Company Routes ================= */} 
...
<Route path="/tickets/:ticketId/activities" element={<TicketActivities />}/> 
